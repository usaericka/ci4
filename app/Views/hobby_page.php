...
<div id="demo" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="/assets/images/codm.jpg" alt="CODM" class="d-block" style="width:100%">
            <div class="carousel-caption d-none d-md-block">
                <p id="simuli">FPS</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="/assets/images/minecraft.jpg" alt="Minecraft" class="d-block" style="width:100%">
            <div class="carousel-caption d-none d-md-block">
                <p id="simuli">Sandbox survival</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="/assets/images/simulation.jpg" alt="Simulation" class="d-block" style="width:100%">
            <div class="carousel-caption d-none d-md-block">
                <p id="simuli">Simulation</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="/assets/images/puzzle.jpg" alt="Puzzle" class="d-block" style="width:100%">
            <div class="carousel-caption d-none d-md-block">
...
<div id="mode" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="/assets/images/youtube.jpg" alt="Youtube" class="d-block" style="width:100%">
            <div class="carousel-caption d-none d-md-block">
                <p id="simuli">Youtube</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="/assets/images/spotify.jpg" alt="Spotify" class="d-block" style="width:100%">
            <div class="carousel-caption d-none d-md-block">
                <p id="simuli">Spotify</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="/assets/images/instgram.jpg" alt="Instagram" class="d-block" style="width:100%">
            <div class="carousel-caption d-none d-md-block">
                <p id="simuli">Instagram</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="/assets/images/tiktok.jpg" alt="Tiktok" class="d-block" style="width:100%">
            <div class="carousel-caption d-none d-md-block">
                <p id="simuli">Tiktok</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="/assets/images/wattpad.jpg" alt="Wattpad" class="d-block" style="width:100%">
            <div class="carousel-caption d-none d-md-block">
