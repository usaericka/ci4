...
<div class="container-fluid bg-custom mt-1">
      <div class="row py-3" style="height:280px">
        <div class="col">  
          <img src="/assets/images/me.jpg" class="rounded-circle" style="width:250px" alt="picture of myself"/>
        </div>
    ...
    <div class="mt-4">
      <div class="container mb-5">
        <div id="logo" class="row">
          <div class="col">
            <img src="/assets/images/Ateneo_de_Iloilo_Seal.svg.png" alt="ADI logo">
          ...
          <div class="col">
            <img src="/assets/images/University_of_San_Agustin_Logo.png" alt="USA logo">
            <div class="text-start">
      ...
      <div class="container-fluid mt-3 bg-bottom py-3">
        ...
        <div class="row">
          <div class="col-4 mt-1 mx-5">
              <img src="/assets/images/bagger.jpg" class="img-fluid" alt="Bagger">
          </div>
          <div class="col-5">
      ...
      <div class="container-fluid bg-bottom py-3">
        <div class="row">
          ...
          <div class="col-4 mt-1 ms-auto mx-4">
            <img src="/assets/images/St. Anna Parish.jpg" class="img-fluid" alt="St. Anna Parish">
          </div>
        </div>
        <hr class="hr hr-blurry"/>
      </div>
        ...
        <div class="container-fluid bg-bottom py-3">
          <div class="row">
            <div class="col-4 mt-1 mx-5">
              <img src="/assets/images/WVMC.jpg" class="img-fluid" alt="WVMC">
            </div>
            <div class="col-5">
